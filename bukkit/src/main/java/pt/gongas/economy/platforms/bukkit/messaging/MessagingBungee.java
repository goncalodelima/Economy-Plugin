...
package pt.gongas.economy.platforms.bukkit.messaging;
...
public class MessagingBungee implements Messaging {
    ...
    @Override
    public void setup() {
        Bukkit.getServer().getMessenger().registerOutgoingPluginChannel(BukkitEconomyPlugin.plugin, "BungeeCord");
    }
    ...
    public void sendMessage(String target, String message) {
        ...
        Bukkit.getServer().sendPluginMessage(BukkitEconomyPlugin.plugin, "BungeeCord", out.toByteArray());
    }
